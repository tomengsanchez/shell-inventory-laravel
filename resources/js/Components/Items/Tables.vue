<template>
    <div class="container mx-auto p-4">
      <NavLink :href="route('add-item')" class="inline-block bg-green-500 text-white py-2 px-4 rounded-full hover:bg-green-600">
    Add New Item
  </NavLink> <br><br>
      <div class="mb-4">
      ...
      <table class="min-w-full bg-white">
        ...
        <tbody>
          <tr v-for="item in data.data" :key="item.id">
            ...
            <td class="text-center py-2 px-8">{{ item.item_types }}</td>
            <td>
